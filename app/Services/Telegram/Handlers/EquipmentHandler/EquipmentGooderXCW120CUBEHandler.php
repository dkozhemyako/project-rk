...
class EquipmentGooderXCW120CUBEHandler implements CommandsInterface
{
            ...
            'keyboard' =>
                [
                    [ //строка
                        /*
                        [ //кнопка
                            'text' => '📌 Характеристики XCW-120 CUBE',
                        ],
                        */
                        [ //кнопка
                            'text' => '🎬 Відео інструкція XCW-120 CUBE',
                        ],
    ...
    public function handle(string $message, int $senderId, string $fileName, int $callback, int $mediaGroupId): MessageDTO
    {
        $this->client->post(
            ...
            [
                'json' => [
                    'chat_id' => $senderId,
                    'media' => [
                        ['type' => 'photo', 'media' => config('messenger.telegram.ngrok').'/'. 'GooderXCW120CUBE/GooderXCW120CUBE-1.jpg'],
                        ['type' => 'photo', 'media' => config('messenger.telegram.ngrok').'/'. 'GooderXCW120CUBE/GooderXCW120CUBE-2.jpg'],
                        ['type' => 'photo', 'media' => config('messenger.telegram.ngrok').'/'. 'GooderXCW120CUBE/GooderXCW120CUBE-3.jpg'],
                        ['type' => 'photo', 'media' => config('messenger.telegram.ngrok').'/'. 'GooderXCW120CUBE/GooderXCW120CUBE-4.jpg'],
                    ],
                ],
            ]
        );
        ...
        $message .= 'Характеристики Gooder XCW-120 CUBE.'.PHP_EOL.PHP_EOL;
