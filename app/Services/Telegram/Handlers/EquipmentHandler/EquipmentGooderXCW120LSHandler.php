...
class EquipmentGooderXCW120LSHandler implements CommandsInterface
{
        ...
        $this->client->post(
            ...
            [
                'json' => [
                    'chat_id' => $senderId,
                    'media' => [
                        ['type' => 'photo', 'media' => config('messenger.telegram.ngrok').'/'. 'GooderXCW120LS/GooderXCW120LS-1.jpg'],
                        ['type' => 'photo', 'media' => config('messenger.telegram.ngrok').'/'. 'GooderXCW120LS/GooderXCW120LS-2.jpg'],
                    ],
                ],
            ]
        );
