    ...
    public function handle(FinalAgreementDTO $finalAgreementDTO, Closure $next): FinalAgreementDTO
    {
        ...
        if($finalAgreementDTO->getMessage() === TelegramCommandEnum::clientCheckAgreementTrue->value){
            ...
            $arrayQuery1 = array(
                ...
                'text' => "💬 Чудово, наступний крок. На договір, який ви перевірили, потрібно накласти підпис за допомогою Дія. Відеоінструкція нижче. ❗❗❗Зверніть увагу❗❗❗, якщо доставка обладанання буде в межах міста Києва то накладати електронний підпис не треба.",
                'parse_mode' => 'HTML',
            );
