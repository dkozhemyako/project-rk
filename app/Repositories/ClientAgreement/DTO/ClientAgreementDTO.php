...
class ClientAgreementDTO
{
    ...
    protected string $clientTown;
    protected string $clientStreet;
    protected string $clientHouse;
    protected string $clientFlat;
    protected string $equipRegion;
    protected string $equipTown;
    protected string $equipStreet;
    protected string $equipHouse;
